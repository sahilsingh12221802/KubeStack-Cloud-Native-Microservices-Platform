            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-cyan-300">
                  Infrastructure metrics coming next
                </h3>

                <p className="mt-1 text-sm text-slate-400">
                  CPU usage, memory usage, pod health, uptime, and live
                  infrastructure metrics will be connected through
                  Prometheus and Grafana in the next monitoring phase.
                </p>
              </div>
            </div>
          </div>
